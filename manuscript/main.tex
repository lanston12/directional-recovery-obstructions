...
\begin{figure}[H]
\centering\includegraphics[width=.99\linewidth]{fig1_framework.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=.98\linewidth]{fig1_recovery_collision_aware.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=.99\linewidth]{fig2_directional_obstruction.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=.96\linewidth]{fig3_linear_constraint_rows.pdf}
...
\begin{figure}[htbp]
\centering\includegraphics[width=.96\linewidth]{fig4_paired_tradeoff.pdf}
...
This study uses synthetic trajectories. Numerical sources are mapped in the accompanying source-data inventory and packaged without alteration for journal upload. They include the original 1,848-run nonlinear table, the separate 24-run OVM/FVD check, sampled-linear results, representative trajectories and failure logs. Reviewer access requires the authors to upload the local archives or supply a working link during submission; no public repository or identifier has yet been assigned.

\section*{Code availability}
Simulation, configuration, analysis and figure code is organized in the accompanying reviewer package, with reproduction commands in its README. Reviewer access requires author upload or a working link in the submission system; no public code release or identifier has yet been assigned.
